...
```powershell
$env:CDSE_USER = "your-email@example.com"
...
```powershell
[Environment]::SetEnvironmentVariable("CDSE_USER", "your-email@example.com", "User")
...
```powershell
$OutDir = "D:\GIS_Data\Copernicus_DEM"
```
...
```powershell
cd "C:\path\to\data_acquisition\scripts"
```
